...
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 1) LIQUIDEZ,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 2) COMISSAOLIQUIDEZ,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 3) PERC_INAD,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 4) PERC_COB_FORN_FIN,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 5) PERC_COB_FORN_POS,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 6) PERC_COB_LUCRO,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 7) META_LUCRO,
fnc_wn_premiacao_comissao('2', TAB1.CODUSUR, to_date(:DTINICIO,'dd-mm-rrrr'), to_date(:DTFIM,'dd-mm-rrrr'), 8) PERC_LUCRO
from (
...
DTFIM = '31/12/2023'
INSS = '8'
PERC_MIN_META_FIN = '70'
PERC_MAX_META_FIN = '130'
PESO_META_FIN = '25'
PERC_MIN_META_FIN_FOR = '70'
PERC_MAX_META_FIN_FOR = '130'
PESO_META_FIN_FOR = '25'
PERC_MIN_META_POS_FOR = '70'
PERC_MAX_META_POS_FOR = '130'
PESO_META_POS_FOR = '25'
PERC_MIN_INAD = '70'
PERC_MAX_INAD = '100'
PESO_INAD = '15'
PERC_MIN_LUCRO = '91'
