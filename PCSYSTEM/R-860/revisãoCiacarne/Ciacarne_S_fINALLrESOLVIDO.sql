...
WHERE 1=1
and PCPEDC.DATA >= to_date('01/09/2023','dd/mm/yyyy') and PCPEDC.DATA <= to_date('30/11/2023','dd/mm/yyyy') 
and PCPEDI.DATA >= to_date('01/09/2023','dd/mm/yyyy') and PCPEDI.DATA <= to_date('30/11/2023','dd/mm/yyyy') 
