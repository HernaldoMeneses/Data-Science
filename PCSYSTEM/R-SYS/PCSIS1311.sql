----------------------------------
Timestamp: 08:58:33.063
SELECT PCNFENT.NUMNOTA, PCNFENT.CODFUNCLANC,
       PCNFENT.DTENT,
       PCNFENT.DTSAIDA,
       PCNFSAID.NUMCAR,
 ...
 PCNFENT.CODUSURDEVOL CODUSURDEVOL,
       ...
       FUNC.NOME NOMEFUNC,
       (SELECT   SUM(NVL(PCMOV.QTAVARIA,0))
       FROM PCMOV
      ...
      (SELECT   SUM (PCMOV.qtavaria * PCMOV.PUNIT)
       FROM PCMOV
       WHERE PCMOV.NUMTRANSENT = PCNFENT.NUMTRANSENT
       AND PCMOV.CODFILIAL = PCNFENT.CODFILIAL 
       AND PCMOV.CODOPER IN ('ED','EN') 
      ...
      '*' AS CONF_NOME,
        PCNFENT.VLFRETE,
        PCNFENT.VLOUTRAS,
        DECODE(PCNFENT.VLTOTAL,0,PCESTCOM.VLDEVOLUCAO,PCNFENT.VLTOTAL) - NVL(PCNFENT.VLOUTRAS,0)  - NVL(PCNFENT.VLFRETE,0)AS 
VLTOTNF 
