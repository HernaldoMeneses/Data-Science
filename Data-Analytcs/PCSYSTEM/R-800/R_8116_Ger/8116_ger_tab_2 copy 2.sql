select distinct(tabInit2.codgerente) as codgerente,
tabInit2.codsupervisor,
sum(clqtclicad) as clqtclicad,
sum(clqtcliativ) as clqtcliativ,
sum(qtcli) as qtcli
 from (
SELECT --Obj1.3_init
     pcsuperv.codgerente,
         ...
         ((SELECT --Obj1.3.1_init
               ...
               + (SELECT COUNT(DISTINCT(PCCLIENT.CODCLI))
               FROM pcusurcli, pcclient, pcsuperv
          ...
          FROM 
               ...
               (SELECT  PCPEDC.CODUSUR  CODUSUR,COUNT(DISTINCT(PCPEDI.CODPROD)) AS QTMIX
                   ...
                   -- AND pcusuari.codusur = financ.codusur(+)
                    ...
                    group by tabInit2.codgerente, tabInit2.codsupervisor