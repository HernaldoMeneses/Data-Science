...
AND PCPRODUT.CODFORNEC in (Select pcfornec.codfornec from pcfornec where pcfornec.codcomprador in (:cod_Comprador))
...
where LIneBY_bP1.codfornec in (Select codfornec from pcfornec where codcomprador in (:cod_Comprador))