...
replace(PCFORNEC.CODCOMPRADOR,'584','000') as cod0001,  
cast(PCFORNEC.CODCOMPRADOR as int) as codcomprador,
cast(PCPRODUT.CODFORNEC as int) as codfornec, 
cast(PCPEDI.CODPROD as int) as codprod, 
--PCPRODUT.DESCRICAO,
